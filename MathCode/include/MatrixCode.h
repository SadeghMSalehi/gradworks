...
public:
    ...
    DVec(T a, T b) : length(N)  {
        _V[0] = a;
        _V[1] = b;
    }
    DVec(T a, T b, T c) : length(N)  {
        _V[0] = a;
        _V[1] = b;
        _V[2] = c;
    }
    DVec(T a, T b, T c, T d) : length(N)  {
        _V[0] = a;
        _V[1] = b;
        _V[2] = c;
        _V[3] = d;
...
public:
    ...
    T det() {
        ...
        case 3:
            return _d[0] * (_d[4] * _d[8] - _d[5] * _d[7]) + _d[1] * (_d[5] * _d[6] - _d[3] * _d[8])
    ...
    SquareMatrixR<T, N>& inverse(SquareMatrixR<T, N>& o, T* det) {
        if (N == 2) {
            ...
            *det = _d[0] * o._d[0] + _d[1] * o._d[3] + _d[2] * o._d[6];
            ...
            o._d[0] = _d[5] * _d[10] * _d[15] + _d[6] * _d[11] * _d[13] + _d[7] * _d[9] * _d[14]
                            - _d[5] * _d[11] * _d[14] - _d[6] * _d[9] * _d[15] - _d[7] * _d[10] * _d[13];
            o._d[1] = _d[1] * _d[11] * _d[14] + _d[2] * _d[9] * _d[15] + _d[3] * _d[10] * _d[13]
                            - _d[1] * _d[10] * _d[15] - _d[2] * _d[11] * _d[13] - _d[3] * _d[9] * _d[14];
            o._d[2] = _d[1] * _d[6] * _d[15] + _d[2] * _d[7] * _d[13] + _d[3] * _d[5] * _d[14] - _d[1] * _d[7] * _d[14]
                            - _d[2] * _d[5] * _d[15] - _d[3] * _d[6] * _d[13];
            o._d[3] = _d[1] * _d[7] * _d[10] + _d[2] * _d[5] * _d[11] + _d[3] * _d[6] * _d[9] - _d[1] * _d[6] * _d[11]
                            - _d[2] * _d[7] * _d[9] - _d[3] * _d[5] * _d[10];
            o._d[4] = _d[4] * _d[11] * _d[14] + _d[6] * _d[8] * _d[15] + _d[7] * _d[10] * _d[12]
                            - _d[4] * _d[10] * _d[15] - _d[6] * _d[11] * _d[12] - _d[7] * _d[8] * _d[14];
            o._d[5] = _d[0] * _d[10] * _d[15] + _d[2] * _d[11] * _d[12] + _d[3] * _d[8] * _d[14]
                            - _d[0] * _d[11] * _d[14] - _d[2] * _d[8] * _d[15] - _d[3] * _d[10] * _d[12];
            o._d[6] = _d[0] * _d[7] * _d[14] + _d[2] * _d[4] * _d[15] + _d[3] * _d[6] * _d[12] - _d[0] * _d[6] * _d[15]
                            - _d[2] * _d[7] * _d[12] - _d[3] * _d[4] * _d[14];
            o._d[7] = _d[0] * _d[6] * _d[11] + _d[2] * _d[7] * _d[8] + _d[3] * _d[4] * _d[10] - _d[0] * _d[7] * _d[10]
                            - _d[2] * _d[4] * _d[11] - _d[3] * _d[6] * _d[8];
            o._d[8] = _d[4] * _d[9] * _d[15] + _d[5] * _d[11] * _d[12] + _d[7] * _d[8] * _d[13]
                            - _d[4] * _d[11] * _d[13] - _d[5] * _d[8] * _d[15] - _d[7] * _d[9] * _d[12];
            o._d[9] = _d[0] * _d[11] * _d[13] + _d[1] * _d[8] * _d[15] + _d[3] * _d[9] * _d[12] - _d[0] * _d[9] * _d[15]
                            - _d[1] * _d[11] * _d[12] - _d[3] * _d[8] * _d[13];
            o._d[10] = _d[0] * _d[5] * _d[15] + _d[1] * _d[7] * _d[12] + _d[3] * _d[4] * _d[13] - _d[0] * _d[7] * _d[13]
                            - _d[1] * _d[4] * _d[15] - _d[3] * _d[5] * _d[12];
            o._d[11] = _d[0] * _d[7] * _d[9] + _d[1] * _d[4] * _d[11] + _d[3] * _d[5] * _d[8] - _d[0] * _d[5] * _d[11]
                            - _d[1] * _d[7] * _d[8] - _d[3] * _d[4] * _d[9];
            o._d[12] = _d[4] * _d[10] * _d[13] + _d[5] * _d[8] * _d[14] + _d[6] * _d[9] * _d[12]
                            - _d[4] * _d[9] * _d[14] - _d[5] * _d[10] * _d[12] - _d[6] * _d[8] * _d[13];
            o._d[13] = _d[0] * _d[9] * _d[14] + _d[1] * _d[10] * _d[12] + _d[2] * _d[8] * _d[13]
                            - _d[0] * _d[10] * _d[13] - _d[1] * _d[8] * _d[14] - _d[2] * _d[9] * _d[12];
            o._d[14] = _d[0] * _d[6] * _d[13] + _d[1] * _d[4] * _d[14] + _d[2] * _d[5] * _d[12] - _d[0] * _d[5] * _d[14]
                            - _d[1] * _d[6] * _d[12] - _d[2] * _d[4] * _d[13];
            o._d[15] = _d[0] * _d[5] * _d[10] + _d[1] * _d[6] * _d[8] + _d[2] * _d[4] * _d[9] - _d[0] * _d[6] * _d[9]
                            - _d[1] * _d[4] * _d[10] - _d[2] * _d[5] * _d[8];

            *det = _d[0] * o._d[0] + _d[1] * o._d[4] + _d[2] * o._d[8] + _d[3] * o._d[12];
        }
        return o;
    }
...
inline Vec4& mult(Mat4& a, Vec4& b, Vec4& c) {
    ...
    c[3] = a._d[12] * b[0] + a._d[13] * b[1] + a._d[14] * b[2] + a._d[15] * b[3];
    return c;
}
