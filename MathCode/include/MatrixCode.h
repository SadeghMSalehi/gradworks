	...
	SquareMatrixR<T, N>& inverse(SquareMatrixR<T, N>& o, T* det) {
		if (N == 2) {
			...
			*det = _d[0] * o._d[0] + _d[1] * o._d[3] + _d[2] * o._d[6];
			...
			o._d[0] = _d[5] * _d[10] * _d[15] + _d[6] * _d[11] * _d[13] + _d[7] * _d[9] * _d[14] - _d[5] * _d[11] * _d[14]
					- _d[6] * _d[9] * _d[15] - _d[7] * _d[10] * _d[13];
			o._d[1] = _d[1] * _d[11] * _d[14] + _d[2] * _d[9] * _d[15] + _d[3] * _d[10] * _d[13] - _d[1] * _d[10] * _d[15]
			...
			o._d[4] = _d[4] * _d[11] * _d[14] + _d[6] * _d[8] * _d[15] + _d[7] * _d[10] * _d[12] - _d[4] * _d[10] * _d[15]
					- _d[6] * _d[11] * _d[12] - _d[7] * _d[8] * _d[14];
			o._d[5] = _d[0] * _d[10] * _d[15] + _d[2] * _d[11] * _d[12] + _d[3] * _d[8] * _d[14] - _d[0] * _d[11] * _d[14]
			...
			o._d[8] = _d[4] * _d[9] * _d[15] + _d[5] * _d[11] * _d[12] + _d[7] * _d[8] * _d[13] - _d[4] * _d[11] * _d[13]
			...
			o._d[12] = _d[4] * _d[10] * _d[13] + _d[5] * _d[8] * _d[14] + _d[6] * _d[9] * _d[12] - _d[4] * _d[9] * _d[14]
					- _d[5] * _d[10] * _d[12] - _d[6] * _d[8] * _d[13];
			o._d[13] = _d[0] * _d[9] * _d[14] + _d[1] * _d[10] * _d[12] + _d[2] * _d[8] * _d[13] - _d[0] * _d[10] * _d[13]
