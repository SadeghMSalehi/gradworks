 ...
 *
 *=========================================================================*/
#ifndef __itkMyEulerTransform_hxx
#define __itkMyEulerTransform_hxx

#include "itkMyEulerTransform.h"

namespace itk
{
    // Constructor with default arguments
    template <class TScalarType>
    MyEulerTransform<TScalarType>
    ::MyEulerTransform() :
    ...
    template <class TScalarType>
    MyEulerTransform<TScalarType>
    ::MyEulerTransform(unsigned int parametersDimension) :
    Superclass(parametersDimension)
    {
        m_ComputeZYX = false;
        m_AngleX = m_AngleY = m_AngleZ = NumericTraits<ScalarType>::Zero;
        m_ScaleX = m_ScaleY = m_ScaleZ = NumericTraits<ScalarType>::One;
    }
    ...
    // Get Parameters
    template <class TScalarType>
    const typename MyEulerTransform<TScalarType>::ParametersType
    & MyEulerTransform<TScalarType>
    ...
    void
    MyEulerTransform<TScalarType>
    ::SetRotation(ScalarType scaleX, ScalarType scaleY, ScalarType scaleZ)
    {
        m_ScaleX = scaleX;
        m_ScaleY = scaleY;
        m_ScaleZ = scaleZ;
    ...
    template <class TScalarType>
    void
    MyEulerTransform<TScalarType>::PrintSelf(std::ostream & os, Indent indent) const
    {
        ...
        << " AngleZ=" << m_AngleZ
        << std::endl;
        os << indent << "Scales: " << m_ScaleX << ", " << m_ScaleY << ", " << m_ScaleZ << endl;
