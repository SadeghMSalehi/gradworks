	...
	public:
        ...
        ImagePointer ReadCastedImage(std::string inputFilename, ImageInfo& type) {
            ...
            switch (pixelType) {
                ...
                {
                    typedef itk::Image<double,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::FLOAT:
                {
                    typedef itk::Image<float,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::SHORT:
                {
                    typedef itk::Image<short,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::USHORT:
                {
                    typedef itk::Image<unsigned short,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::UCHAR:
                {
                    typedef itk::Image<unsigned char,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::CHAR:
                {
                    typedef itk::Image<char,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::ULONG:
                {
                    typedef itk::Image<unsigned long,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::LONG:
                {
                    typedef itk::Image<long,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::INT:
                {
                    typedef itk::Image<int,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                case itk::ImageIOBase::UINT:
                {
                    typedef itk::Image<unsigned int,numDimensions> I;
                    return CastImageFromS<I>(ReadImageS<I>(inputFilename));
                    break;
                }
                default:
