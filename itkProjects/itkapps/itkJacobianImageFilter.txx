/*=========================================================================
  ...
  Module:    $RCSfile: itkJacobianImageFilter.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef _itkJacobianImageFilter_txx
#define _itkJacobianImageFilter_txx
#include "itkJacobianImageFilter.h"
...
void 
JacobianImageFilter<TInputImage, TOperatorValueType, TOutputValueType>
                       ...
                       int threadId)
{
  ...
  for (fit=faceList.begin(); fit != faceList.end(); ++fit)
    ...
    while ( ! nit.IsAtEnd() )
      ...
      for (i = 0; i < InputImageDimension; ++i)
        {
          OperatorValueType v = SIP(x_slice[i], nit, op[i]);
          a(0,i) = v[0];
          a(1,i) = v[1];
          a(2,i) = v[2];
        }
