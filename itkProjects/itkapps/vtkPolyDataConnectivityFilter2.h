/*=========================================================================
  ...
  Module:    $RCSfile: vtkPolyDataConnectivityFilter2.h,v $
...
=========================================================================*/
// .NAME  - extract polygonal data based on geometric connectivity
// .SECTION Description
//  is a filter that extracts cells that
...
// polygonal data.
//
// The behavior of  can be modified by turning
...
class vtkPolyDataConnectivityFilter2 : public vtkPolyDataAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkPolyDataConnectivityFilter2,vtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Construct with default extraction mode to extract largest regions.
  static  vtkPolyDataConnectivityFilter2 *New();
  ...
  // Description:
  // Turn on/off connecitvity option if all the scalar values in a cell must meet the scalar range specified
  vtkSetMacro(ExclusiveScalarConnectivity,int);
  vtkGetMacro(ExclusiveScalarConnectivity,int);
  vtkBooleanMacro(ExclusiveScalarConnectivity,int)
...
protected:
  vtkPolyDataConnectivityFilter2();
  ~vtkPolyDataConnectivityFilter2();
  ...
  int ExclusiveScalarConnectivity;
...
private:
  ...
  vtkIdList *CellIds;
private:
  vtkPolyDataConnectivityFilter2(const vtkPolyDataConnectivityFilter2&);  // Not implemented.
  void operator=(const vtkPolyDataConnectivityFilter2&);  // Not implemented.
};

// Description:
// Return the method of extraction as a string.
inline const char *vtkPolyDataConnectivityFilter2::GetExtractionModeAsString(void)
{
