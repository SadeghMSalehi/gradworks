 ...
 *
 *=========================================================================*/
#ifndef __itkMyDenseFiniteDifferenceImageFilter_hxx
#define __itkMyDenseFiniteDifferenceImageFilter_hxx
#include "itkMyDenseFiniteDifferenceImageFilter.h"
...
void
MyDenseFiniteDifferenceImageFilter< TInputImage, TOutputImage >
::CopyInputToOutput()
{
...
template< class TInputImage, class TOutputImage >
typename
MyDenseFiniteDifferenceImageFilter< TInputImage, TOutputImage >::TimeStepType
MyDenseFiniteDifferenceImageFilter< TInputImage, TOutputImage >
::CalculateChange()
{
  // Set up for multithreaded processing.
