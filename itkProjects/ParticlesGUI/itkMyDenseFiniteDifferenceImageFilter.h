 ...
 *
 *=========================================================================*/
#ifndef __itkMyDenseFiniteDifferenceImageFilter_h
#define __itkMyDenseFiniteDifferenceImageFilter_h
...
{
/**
 * \class MyDenseFiniteDifferenceImageFilter
 *
...
class ITK_EXPORT MyDenseFiniteDifferenceImageFilter:
  public FiniteDifferenceImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs */
  typedef MyDenseFiniteDifferenceImageFilter Self;
  ...
  itkTypeMacro(MyDenseFiniteDifferenceImageFilter, ImageToImageFilter);
...
#endif
protected:
  MyDenseFiniteDifferenceImageFilter()
...
private:
  MyDenseFiniteDifferenceImageFilter(const Self &); //purposely not implemented
  void operator=(const Self &);                   //purposely not implemented

  /** Structure for passing information into static callback methods.  Used in
   * the subclasses' threading mechanisms. */
  struct DenseFDThreadStruct {
    MyDenseFiniteDifferenceImageFilter *Filter;
...
#define ITK_TEMPLATE_MyDenseFiniteDifferenceImageFilter(_, EXPORT, TypeX, TypeY)     \
  namespace itk                                                                    \
  {                                                                                \
  _( 2 ( class EXPORT MyDenseFiniteDifferenceImageFilter< ITK_TEMPLATE_2 TypeX > ) ) \
  namespace Templates                                                              \
  {                                                                                \
  typedef MyDenseFiniteDifferenceImageFilter< ITK_TEMPLATE_2 TypeX >                 \
  MyDenseFiniteDifferenceImageFilter##TypeY;                                       \
  }                                                                                \
  }

#if ITK_TEMPLATE_EXPLICIT
#include "Templates/itkMyDenseFiniteDifferenceImageFilter+-.h"
#endif

#if ITK_TEMPLATE_TXX
#include "itkMyDenseFiniteDifferenceImageFilter.hxx"
#endif
