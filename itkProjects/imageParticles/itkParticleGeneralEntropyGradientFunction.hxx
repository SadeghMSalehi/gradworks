...
void
ParticleGeneralEntropyGradientFunction<VDimension>::ComputeUpdates()
{  
...
ParticleGeneralEntropyGradientFunction<VDimension>::Evaluate(unsigned int idx, unsigned int d, const ParticleSystemType * system,
