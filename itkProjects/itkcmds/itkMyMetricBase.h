 ...
 *
 *=========================================================================*/
#ifndef __itkMyMetricBase_h
#define __itkMyMetricBase_h
...
class ITK_EXPORT MyMetricBase: public SingleValuedCostFunction {
public:
	/** Standard class typedefs. */
	typedef MyMetricBase Self;
	...
	itkTypeMacro(MyMetricBase, SingleValuedCostFunction)
	;
    ...
    private:
        MyMetricBase(const Self &); //purposely not implemented
