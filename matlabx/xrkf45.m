function [S,K] = xrkf45(f,a,b,ya,m,tol)
%---------------------------------------------------------------------------
...
while (T(j)<b),
  ...
  % current time, current error, scaling value, current h, current y, new y
  S(end+1,:) = [ tj, err, s, h0, h, yj, ynew ];
