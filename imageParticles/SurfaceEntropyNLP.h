 ...
 *
 */
class SurfaceEntropyNLP : public TNLP
{
private:
    const static int m_Dimensions = 2;
    int m_NumberOfPoints = 2;
    arma::mat m_InitialPoints;
    arma::vec m_Region;
    arma::vec m_ImageCenter;
    arma::vec m_Radius;
    arma::vec m_ResultPoints;
    double m_FinalCost;
...
public:
    ...
    void SetInitialPoints(arma::mat initialPoints) {
        m_InitialPoints = initialPoints;
    }

    void SetRegion(arma::vec region) {
        m_Region = region;
    }

    void SetCenter(arma::vec imageCenter) {
        m_ImageCenter = imageCenter;
    }

    void SetRadius(arma::vec radius) {
        m_Radius = radius;
    }
...
private:
    ...
    //@{
    //  HS071_NLP();
    SurfaceEntropyNLP(const SurfaceEntropyNLP&);
    SurfaceEntropyNLP& operator=(const SurfaceEntropyNLP&);
    //@}
};
