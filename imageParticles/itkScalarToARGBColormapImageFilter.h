 ...
 *
 *=========================================================================*/
#ifndef __itkScalarToARGBColormapImageFilter_h
#define __itkScalarToARGBColormapImageFilter_h
...
namespace itk
{
    /** \class ScalarToARGBColormapImageFilter
     ...
     *
     * \wiki
     * \wikiexample{SimpleOperations/ScalarToARGBColormapImageFilter,Apply a color map to an image}
     * \endwiki
     */
...
#include "itkScalarToARGBColormapImageFilter.hxx"
#endif
