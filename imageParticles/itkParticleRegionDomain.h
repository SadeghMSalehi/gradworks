/*=========================================================================
  ...
  Date:      $Date: 2010/11/19 13:17:02 $
  Version:   $Revision: 1.3 $
  Author:    $Author: ljoohwi $
    ...
    for (unsigned int i = 0; i < VDimension; i++)
      ...
      //        }
            ...
            if ( p[i] < m_LowerBound[i]  || p[i] > m_UpperBound[i])
              {
               itkExceptionMacro(<< i << "th (" << p[i] << ") element of Point " << p << " is outside of the specified Domain,  with bounding box "
...
#if ITK_TEMPLATE_TXX
//# include "itkParticleRegionDomain.hxx"
#endif
