 ...
 *
 *=========================================================================*/
#ifndef __itkMyPowellOptimizer_h
#define __itkMyPowellOptimizer_h
...
class ITK_EXPORT MyPowellOptimizer: public SingleValuedNonLinearOptimizer {
public:
	/** Standard "Self" typedef. */
	typedef MyPowellOptimizer Self;
	...
	itkTypeMacro(MyPowellOptimizer, SingleValuedNonLinearOptimizer)
	;
...
protected:
	MyPowellOptimizer();
	MyPowellOptimizer(const MyPowellOptimizer &);
	virtual ~MyPowellOptimizer();
	...
	virtual void LineBracket(double *ax, double *bx, double *cx, double *fa,
			double *fb, double *fc);

	virtual void LineBracket(double *ax, double *bx, double *cx, double *fa,
			double *fb, double *fc, ParametersType & tempCoord);
	...
	virtual void BracketedLineOptimize(double ax, double bx, double cx,
			double fa, double fb, double fc, double *extX, double *extVal);
