 ...
 * @webref math
 */
public class QVector implements Serializable {
 ...
 */
   ...
   */
  static public QVector add(QVector v1, QVector v2) {
   ...
   */
  static public QVector add(QVector v1, QVector v2, QVector target) {
    if (target == null) {
      target = new QVector(v1.x + v2.x,v1.y + v2.y, v1.z + v2.z);
    } else {
 ...
 */
   ...
   */
  static public QVector sub(QVector v1, QVector v2) {
   ...
   */
  static public QVector sub(QVector v1, QVector v2, QVector target) {
    if (target == null) {
      target = new QVector(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
    } else {
      target.set(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
   ...
   */
  static public QVector mult(QVector v, float n) {
   ...
   * @param target PVector to store the result
   */
  static public QVector mult(QVector v, float n, QVector target) {
    if (target == null) {
      target = new QVector(v.x*n, v.y*n, v.z*n);
    } else {
   ...
   */
  static public QVector mult(QVector v1, QVector v2) {
    return mult(v1, v2, null);
  }

  
  static public QVector mult(QVector v1, QVector v2, QVector target) {
    if (target == null) {
      target = new QVector(v1.x*v2.x, v1.y*v2.y, v1.z*v2.z);
    } else {
      target.set(v1.x*v2.x, v1.y*v2.y, v1.z*v2.z);
   ...
   */
  static public QVector div(QVector v, float n) {
    return div(v, n, null);
  }
   ...
   * @param target PVector to store the result
   */
  static public QVector div(QVector v, float n, QVector target) {
    if (target == null) {
      target = new QVector(v.x/n, v.y/n, v.z/n);
    } else {
      target.set(v.x/n, v.y/n, v.z/n);
   ...
   */
  static public QVector div(QVector v1, QVector v2) {
    return div(v1, v2, null);
  }

  static public QVector div(QVector v1, QVector v2, QVector target) {
    if (target == null) {
      target = new QVector(v1.x/v2.x, v1.y/v2.y, v1.z/v2.z);
    } else {
      target.set(v1.x/v2.x, v1.y/v2.y, v1.z/v2.z);
   ...
   */
  static public float dist(QVector v1, QVector v2) {
    float dx = v1.x - v2.x;
    float dy = v1.y - v2.y;
    float dz = v1.z - v2.z;
    return (float) Math.sqrt(dx*dx + dy*dy + dz*dz);
   ...
   * @param v2 any variable of type PVector
   */
  static public float dot(QVector v1, QVector v2) {
   ...
   */
  public QVector cross(QVector v) {
    return cross(v, null);
  }
   ...
   * @param target PVector to store the result
   */
  public QVector cross(QVector v, QVector target) {
    float crossX = y * v.z - v.y * z;
    float crossY = z * v.x - v.z * x;
    float crossZ = x * v.y - v.x * y;

    if (target == null) {
      target = new QVector(crossX, crossY, crossZ);
    } else {
   ...
   * @param target PVector to store the result
   */
  static public QVector cross(QVector v1, QVector v2, QVector target) {
   ...
   */
  public QVector normalize(QVector target) {
    if (target == null) {
      target = new QVector();
    }
    float m = mag();
   ...
   * @return a new vector (if target was null), or target
   */
  public QVector setMag(QVector target, float len) {
   ...
   * @param QVector the vector to lerp to
   ...
   */
  public void lerp(QVector v, float amt) {
   ...
   */
  static public float angleBetween(QVector v1, QVector v2) {
