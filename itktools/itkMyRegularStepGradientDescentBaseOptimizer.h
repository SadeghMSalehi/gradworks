 ...
 *
 *=========================================================================*/
#ifndef __itkMyRegularStepGradientDescentBaseOptimizer_h
#define __itkMyRegularStepGradientDescentBaseOptimizer_h
...
namespace itk
{
    /** \class MyRegularStepGradientDescentBaseOptimizer
     * \brief Implement a gradient descent optimizer
     *
     * \ingroup Numerics Optimizers
     * \ingroup ITKOptimizers
     */
    class ITK_EXPORT MyRegularStepGradientDescentBaseOptimizer:
    public SingleValuedNonLinearOptimizer
    {
    public:
        /** Standard "Self" typedef. */
        typedef MyRegularStepGradientDescentBaseOptimizer Self;
        ...
        itkTypeMacro(MyRegularStepGradientDescentBaseOptimizer,
    ...
    protected:
        ...
        virtual ~MyRegularStepGradientDescentBaseOptimizer() {}
    ...
    private:
        MyRegularStepGradientDescentBaseOptimizer(const Self &); //purposely not
        // implemented
