 ...
 *
 *=========================================================================*/
#ifndef __itkMyTransformFilter_h
#define __itkMyTransformFilter_h
...
/** \class itkMyTransformFilter
 * \brief Resample an image via a coordinate transform
 *
 * itkMyTransformFilter resamples an existing image through some coordinate
 ...
 * \wikiexample{ImageProcessing/itkMyTransformFilter,Resample (stretch or compress) an image}
 * \endwiki
 */
...
#include "itkMyTransformFilter.hxx"
#endif
