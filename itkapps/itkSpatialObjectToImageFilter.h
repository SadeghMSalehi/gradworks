...
=========================================================================*/
#ifndef __itkSpatialFunctionToImageFilter_h
#define __itkSpatialFunctionToImageFilter_h
...
/** \class SpatialFunctionToImageFilter
 * \brief Base class for filters that take a SpatialFunction 
 ...
 *  Spatial object.
 */
template <class TInputImage, class TInputSpatialFunction, class TOutputImage>
class ITK_EXPORT SpatialFunctionToImageFilter : public ImageSource<TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef SpatialFunctionToImageFilter                   Self;
  ...
  itkTypeMacro(SpatialFunctionToImageFilter, ImageSource);

  /** Superclass typedefs. */
  typedef typename Superclass::OutputImageRegionType      OutputImageRegionType;

  /** Some convenient typedefs. */
  typedef TInputSpatialFunction                             InputSpatialFunctionType;

  /** ImageDimension constants */
  itkStaticConstMacro(ObjectDimension, unsigned int,
                      InputSpatialFunctionType::ObjectDimension);

  itkStaticConstMacro(OutputImageDimension, unsigned int,
                      TOutputImage::ImageDimension);

  /** Set/Get the image input of this process object.  */
  virtual void SetInput( const InputSpatialFunctionType *object);
  virtual void SetInput( unsigned int, const InputSpatialFunctionType * object);
  const InputSpatialFunctionType * GetInput( void );
  const InputSpatialFunctionType * GetInput( unsigned int idx );
...
private:
  ...
  SpatialFunctionToImageFilter(const Self&); //purposely not implemented
...
#include "itkSpatialFunctionToImageFilter.txx"
#endif
