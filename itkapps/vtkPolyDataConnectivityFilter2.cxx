/*=========================================================================
  ...
  Module:    $RCSfile: vtkPolyDataConnectivityFilter2.cxx,v $
...
vtkCxxRevisionMacro(vtkPolyDataConnectivityFilter2, "$Revision: 1.1.1.1 $");
vtkStandardNewMacro(vtkPolyDataConnectivityFilter2);

// Construct with default extraction mode to extract largest regions.
vtkPolyDataConnectivityFilter2::vtkPolyDataConnectivityFilter2()
{
  ...
  this->ExclusiveScalarConnectivity = 0;
...
int vtkPolyDataConnectivityFilter2::RequestData(
...
//
void vtkPolyDataConnectivityFilter2::TraverseAndMark ()
{
          ...
          for (k=0; k < ncells; k++)
            ...
            if ( this->InScalars )
              ...
              for (ii=0; ii < numScalars;  ii++)
                ...
                if (ExclusiveScalarConnectivity == 0) {
...
int vtkPolyDataConnectivityFilter2::GetNumberOfExtractedRegions()
{
  return this->RegionSizes->GetMaxId() + 1;
}

// Initialize list of point ids/cell ids used to seed regions.
void vtkPolyDataConnectivityFilter2::InitializeSeedList()
{
  this->Modified();
  this->Seeds->Reset();
}
...
void vtkPolyDataConnectivityFilter2::AddSeed(int id)
{
  this->Modified();
...
void vtkPolyDataConnectivityFilter2::DeleteSeed(int id)
{
  this->Modified();
...
void vtkPolyDataConnectivityFilter2::InitializeSpecifiedRegionList()
{
  this->Modified();
...
void vtkPolyDataConnectivityFilter2::AddSpecifiedRegion(int id)
{
  this->Modified();
...
void vtkPolyDataConnectivityFilter2::DeleteSpecifiedRegion(int id)
{
  this->Modified();
  this->SpecifiedRegionIds->DeleteId(id);
}

void vtkPolyDataConnectivityFilter2::PrintSelf(ostream& os, vtkIndent indent)
{
